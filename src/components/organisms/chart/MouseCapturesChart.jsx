    ...
    useEffect(() => {
        async function getLastYearRecords() {
            ...
            try {
                ...
                const categories = Object.keys(mouse).map((time, index) => {
                ...
                const values = Object.values(mouse);
                const maxValue =
                    (Math.ceil(Math.max(...values) / 100) + 1) * 100;
                ...
                setOptions({
                    ...
                    title: {
                        text: 'Number of Mouse Captures for the Last Year',
                        align: 'center',
                        margin: 5,
                        style: {
                            fontSize: '17px',
...
export default MouseCapturesChart;
